...
pub struct InvestmentsScreen;

impl InvestmentsScreen {
    pub fn new() -> Self {
        InvestmentsScreen
    }
}

impl Screen for InvestmentsScreen {
    ...
    fn draw(&mut self, f: &mut Frame, _context: &ScreenContext) {
        ...
        let content_block = Block::default()
            ...
            .title(Span::styled(" 📈 Investments ", Style::default().fg(Color::Blue)));

        let content = Paragraph::new("Investments management coming soon...")
